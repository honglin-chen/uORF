...
python train.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '15337' \
    ...
    --restrict_world \
    --frame5 \
    --silhouette_loss --silhouette_epoch 0 --silhouette_l2_loss --learn_only_silhouette \
#    --continue_train --exp_id latest

# this is copy of 15335
# To compare dice loss clipped and l2 loss
# node 6 cuda 4
