...
python train.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '13043' \
    ...
    --no_locality_epoch 0 \
    --gt_seg --pixel_encoder --mask_image --use_ray_dir --silhouette_loss --weight_pixelfeat \
    --save_latest_freq 500 \
    --reduce_color_decoder --density_as_color_input \
    --restrict_world \
    --continue_train --exp_id 'run-2022-04-28-13-17-12' \
