...
python train_without_gan.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    ...
    --continue_train --exp_id 'run-2022-04-18-00-02-30' \
# done
echo "Done"
# node 5 cuda 4
# stop at 800s epoch.
# at first it learned silhouette, but after 600 epoch it could not learn anything
# now it would be used for debugging model loading
