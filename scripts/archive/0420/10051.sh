...
python train_without_gan.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '10051' \
    ...
    --gt_seg --pixel_encoder --mask_image_feature --mask_image --bg_no_pixel --use_ray_dir --silhouette_loss \
    --continue_train --exp_id 'run-2022-04-18-00-01-39' \
# done
echo "Done"
# node 5 cuda 3
