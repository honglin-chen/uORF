...
python train_without_gan.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '041522_debug' \
    ...
    --gt_seg --pixel_encoder --mask_image_feature --weigh_pixelfeat --bg_no_pixel --silhouette_loss --input_no_loss --use_ray_dir --no_concatenate --shared_pixel_slot_decoder \
# done
echo "Done"
# node 6 cuda 5
