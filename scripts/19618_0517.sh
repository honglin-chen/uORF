...
python train.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '19618_2_0517' \
    --display_port $PORT --display_ncols 4 --print_freq 200 --display_freq 200 --display_grad \
    --load_size 128 --n_samp 128 --input_size 128 --mask_size 128 --supervision_size 64 \
    --niter 40 --coarse_epoch 10 --z_dim 64 --num_slots 2 \
...
#    --silhouette_loss --silhouette_l2_loss --silhouette_expand --bg_no_silhouette_loss --fg_only_delete_bg \
