...
python train_without_gan.py --dataroot $DATAROOT --n_scenes $NSCENES --n_img_each_scene 4  \
    --checkpoints_dir 'checkpoints' --name '11019' \
    ...
    --gt_seg --pixel_encoder --mask_image_feature --mask_image --bg_no_pixel --use_ray_dir --silhouette_loss --weight_pixelfeat --learn_only_silhouette --small_latent \
#    --continue_train --exp_id 'run-2022-04-20-15-36-43' \
# done
echo "Done"
# node 6 cuda 2
